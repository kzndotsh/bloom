...
// When the function is ran, it takes a top down review with collecting information on variables. 
// Because the nestedFunction is exactly what it says, nested, it still has context of what is inside of the greater function.
// We are free to use these variables anywhere in our function.
// The two main concepts behind this are the following:
// closure - functions referencing external variables from inside another function
// lexical scope - the part of the compiler that lets it happen; the variables that a piece of scope has access to
...
lowPopulationAnimals(zooAnimals);
  ...
  */
  ...
  function USApop(array){
    const reducedArr = array.reduce((accumulator, item) => {
...
const cuboidTwo = new CuboidMakerTwo({length: 2, width: 4, height: 6});
